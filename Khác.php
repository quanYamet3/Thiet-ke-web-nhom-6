...
<head>
    ...
    <title>Các phụ kiện khác - Ink Store</title>
</head>
<body>
...
<div class="container main-content" style="margin-top: 100px;">
    <aside class="sidebar">
        ...
        <ul class="category-list">
            ...
            <li><a href="Khác.php" class="active">Các phụ kiện khác</a></li>
        </ul>
    </aside>

    <section class="product-area">
        <div class="breadcrumb">Trang chủ / Sản phẩm / <span>Các phụ kiện khác</span></div>
