...
<head>
    ...
    <title>Tất cả sản phẩm - Ink Store</title>
</head>
<body>
...
<div class="container main-content" style="margin-top: 100px;">
    <aside class="sidebar">
        ...
        <ul class="category-list">
            <li><a href="Tất_cả_sản_phẩm.php" class="active">Tất cả sản phẩm</a></li>
    ...
    <section class="product-area">
        <div class="breadcrumb">Trang chủ / Sản phẩm / <span>Tất cả sản phẩm</span></div>
